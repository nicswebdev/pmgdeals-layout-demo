      ...
      <div className="container">
        ...
        <div className="grid grid-cols-1 4xl:grid-cols-3 gap-4 4xl:gap-8 md:max-4xl:max-w-[40rem] md:max-4xl:mx-auto">
          {[
            ...
            >
              {/* TODO: Put logo here */}
              <div className="w-[6.25rem] aspect-square bg-gray-500"></div>
              <p
