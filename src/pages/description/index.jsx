        ...
        <div className="container">
          ...
          <div className="pb-10">
            ...
            <ul className="pl-6 list-disc font-light lg:text-[1.25rem]">
              ...
              <li>
                The voucher is valid for 6 months starting from the purchase
                date
              </li>
              <li>
                The voucher cannot be combined with other promotions and is not
                eligible for loyalty points
              </li>
              <li>
                To redeem the voucher, guests are required to contact the
                hotel's reservation via phone at +62 361 757 688 or email
                at hello@pmgdeals.com
              </li>
              <li>
                The voucher will be forfeited if it surpasses its expiration
                date
              </li>
              <li>No credit or refund will be given for any unused benefits</li>
              <li>
                The benefits are not transferable and cannot be accumulated
              </li>
              <li>
                The benefits can only be used during the stay at the hotel and
                cannot be cashed out
              </li>
              <li>
                The hotel reserves the right to change any promotion without
                prior notice
              </li>
              <li>
                For an extension of stay please contact reservation at +62 361
                757 688 or hotel website at www.baliniksoma.com
              </li>
            </ul>
          </div>
          ...
          <div className="pb-20">
            ...
            <ul className="pl-6 list-disc font-light lg:text-[1.25rem]">
              ...
              <li>
                An additional charge of IDR 600,000 nett/room/night is required
                for stays during the peak season between 28th December - 4th
                January
              </li>
            </ul>
          </div>
          ...
          <div className="flex">
            <div className="w-full max-w-[22.75rem] max-lg:mx-auto lg:ml-auto">
              <ButtonBasic rounded>BOOK NOW</ButtonBasic>
            </div>
          </div>
        </div>
      </div>
