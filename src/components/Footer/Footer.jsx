    ...
    <footer className="pt-0 lg:pt-20 bg-gray-dark text-white ">
            ...
            <div className="flex max-lg:flex-col max-lg:items-center lg:gap-20">
              ...
              <div className="max-lg:pb-8">
                <div className="max-lg:text-center">
                  ...
                  <p className="pb-4 lg:pb-6 font-open-sans text-[0.75rem] lg:text-[1.375rem]">
                    Phone: 
                    <a href="tel:+62361757688" className="underline">
                      +62 361 757 688
                    </a>
                    <br />
                    Fax: +62 361 4752 979
                    <br />
                    WhatsApp: 
                    <a href="tel:+6281510449090" className="underline">
                      +62 815 1044 9090
                    </a>
                    <br />
                    E-mail: 
                    <a href="mailto:hello@pmgdeals.com" className="underline">
                      hello@pmgdeals.com
                    </a>
                  </p>
                  ...
                  <ul className="flex max-lg:justify-center items-center gap-4">
                    {[
                      {
                        href: "#",
                        icon: <FaFacebookF className="w-6 lg:w-8 h-6 lg:h-8" />,
                      },
                      {
                        href: "#",
                        icon: <FaInstagram className="w-6 lg:w-8 h-6 lg:h-8" />,
                      },
                      {
                        href: "#",
                        icon: <FaWhatsapp className="w-6 lg:w-8 h-6 lg:h-8" />,
                      },
                      {
                        href: "#",
                        icon: <FaTiktok className="w-6 lg:w-8 h-6 lg:h-8" />,
                      },
                    ].map((item, index) => (
                      <li key={`social-${index}`}>
                ...
                <div className="max-lg:text-center">
                  ...
                  <ul className="flex flex-col gap-1 lg:gap-2">
                    {[
                      ...
                      <li key={`social-${index}`} className="leading-none">
                        <a
                          href={item.href}
      ...
      <div className="pt-6 pb-9 border-t border-[#BCBCBC]">
        <p className="text-center font-open-sans text-[0.75rem] lg:text-[1.25rem]">
          ©{new Date().getFullYear()} PMG Hotels & Resorts. All Rights Reserved
        </p>
      </div>
    </footer>
  );
