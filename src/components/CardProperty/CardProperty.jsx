...
export default function CardProperty({deals}) {
    ...
    return (
        <div class="relative grid grid-cols-[70%_30%] gap-0 border-[1px] bg-white">
            ...
            <div className="flex justify-between flex-col">
                    ...
                    <div className="pb-4 px-4 pt-8 lg:pb-6 flex flex-wrap flex-col gap-2">
                        ...
                        <p className="lg:text-[1.2rem]">
                            {deals.deals_base_price && (
                                <span className="inline-block line-through decoration-red decoration-2 decoration-from-font">
                                    {currency}{" "}
                                    {currency === "IDR"
                                        ? idrFormatter.format(
                                              rates[currency]
                ...
                <a
                    href={`/details/${deals.deals_id}`}
                    className="w-full py-6 bg-[#b58a25] uppercase text-white flex justify-center items-center"
                >
                    View Details
                </a>
            </div>
